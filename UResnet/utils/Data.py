...
def load_dataloader(root_dir, phase, transforms, dataloader_params):
    ...
    """
    num_train = 100  # 70%, 40300 slices (volume 1 ~ 260)
    num_valid = 20 # 10% 6200 slices (volume 261 ~ 300)
    num_test = 50 # 20% 10695 slices (volume 301 ~ 369)
    ...
    train_subjects, valid_subjects, test_subjects = unique_volumes[:num_train], unique_volumes[num_train:num_train+num_valid], unique_volumes[num_train+num_valid:num_train+num_valid+num_test]
